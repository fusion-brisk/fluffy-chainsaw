...
export const DEFAULT_PARSING_RULES: ParsingSchema = {
  ...
  rules: {
    ...
    'EDeliveryGroup-Item': {
      domSelectors: ['.EDeliveryGroup-Item', '[class*="EDeliveryGroup-Item"]'],
      jsonKeys: [],
      type: 'text',
    },
    // EPrice_view_special - специальный вид цены (зелёная)
    EPrice_view_special: {
      domSelectors: ['.EPrice_view_special', '[class*="EPrice_view_special"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    // Label_view_outlineSpecial - скидка с outline и словом "Вам"
    Label_view_outlineSpecial: {
      domSelectors: ['.Label_view_outlineSpecial', '[class*="Label_view_outlineSpecial"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    // Fintech - блок рассрочки/оплаты (Сплит/Пэй)
    Fintech: {
      domSelectors: ['.Fintech:not(.Fintech-Icon)', '[class*="EPriceGroup-Fintech"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    ...
    WorkHours: {
      domSelectors: ['.Organic-Meta .Meta-Item'],
    ...
    '#EQuote-Text': {
      domSelectors: ['.EQuote-Text', '[class*="EQuote-Text"]'],
      jsonKeys: ['quoteText'],
      type: 'text',
    },
    ...
    EProductSpecs: {
      domSelectors: ['.EProductSpecs', '[class*="EProductSpecs"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    EProductSpecs_Property: {
      domSelectors: ['.EProductSpecs-Property', '[class*="EProductSpecs-Property"]'],
      jsonKeys: [],
      type: 'text',
    },
    ...
    EProductSpecs_PropertyValue: {
      domSelectors: ['.EProductSpecs-PropertyValue', '[class*="EProductSpecs-PropertyValue"]'],
      jsonKeys: [],
      type: 'text',
    },
    ...
    EShopSplitDiscount: {
      domSelectors: ['.EShopSplitDiscount', '[class*="EShopSplitDiscount"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    EShopSplitDiscount_Price: {
      domSelectors: ['.EShopSplitDiscount-Price', '[class*="EShopSplitDiscount-Price"]'],
      jsonKeys: [],
      type: 'price',
    },
    ...
    EShopSplitDiscount_PayMethod: {
      domSelectors: ['.EShopSplitDiscount-PayMethod', '[class*="EShopSplitDiscount-PayMethod"]'],
      jsonKeys: [],
      type: 'text',
    },
    ...
    EntityCard: {
      domSelectors: ['.EntityCard', '[class*="EntityCard"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    EntityCard_Item: {
      domSelectors: ['.EntityCard-Item', '[class*="EntityCard-Item"]', '.EntityCardItem'],
      jsonKeys: [],
      type: 'text',
    },
    ...
    EProductTabs: {
      domSelectors: ['.EProductTabs', '[class*="EProductTabs"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    EProductTabs_Tab: {
      domSelectors: ['.EProductTabs-Tab', '[class*="EProductTabs-Tab"]'],
      jsonKeys: [],
      type: 'text',
    },
    EProductTabs_Tab_active: {
      domSelectors: ['.EProductTabs-Tab_active', '[class*="EProductTabs-Tab_active"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    ...
    EThumb: {
      domSelectors: ['.EThumb-Image', '[class*="EThumb-Image"]', '.EThumb img'],
      jsonKeys: [],
      type: 'image',
      domAttribute: 'src',
    },
    ...
    Extralinks: {
      domSelectors: ['.Extralinks', '[class*="Extralinks"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    ...
    EOfferItem: {
      domSelectors: ['.EOfferItem', '[class*="EOfferItem"]'],
      jsonKeys: [],
      type: 'boolean',
    },
    ...
    // EOfferItem данные
    EOfferItem_ShopName: {
      domSelectors: ['.EOfferItem-ShopName', '[class*="EOfferItem-ShopName"]'],
      jsonKeys: ['shopName'],
      type: 'text',
    },
    EOfferItem_Price: {
    ...
    EOfferItem_Reviews: {
      domSelectors: ['.EOfferItem-Reviews', '[class*="EOfferItem-Reviews"]'],
    ...
    EOfferItem_Title: {
      domSelectors: ['.EOfferItem-Title', '[class*="EOfferItem-Title"]'],
      jsonKeys: ['title'],
      type: 'text',
    },
    EOfferItem_Button: {
